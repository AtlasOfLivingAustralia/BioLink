...
SELECT CONVERT(datetime, GETDATE(),126) AS DateLastModified,
	...
	Null AS Bbounding,
	CAST(dbo.tblSite.fltElevLower as VARCHAR(20)) + dbo.tblSite.vchrElevUnits AS MinimumElevation,
	CAST(dbo.tblSite.fltElevUpper as VARCHAR(20)) + dbo.tblSite.vchrElevUnits AS MaximumElevation,
	CAST(dbo.tblSite.fltElevDepth as VARCHAR(20)) + dbo.tblSite.vchrElevUnits AS MinimumDepth,
