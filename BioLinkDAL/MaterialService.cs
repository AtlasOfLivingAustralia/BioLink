...
namespace BioLink.Data {
    ...
    public class MaterialService : BioLinkService {
        ...
        public DataMatrix GetDarwinCoreForBiotaID(int biotaID) {

            var taxon = new TaxaService(User).GetTaxon(biotaID);
            ...
            values["where"] = String.Format("tblBiota.vchrParentage LIKE '{0}\\%'", taxon.Parentage);
            ...
            return SQLReaderDataMatrix(sql, formatters, null);
        }
