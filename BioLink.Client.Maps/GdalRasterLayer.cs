...
namespace SharpMap.Layers {
    ...
    public class MyGdalRasterLayer : Layer, ICanQueryLayer, IDisposable {
        ...
        public MyGdalRasterLayer(string strLayerName, string imageFilename) {
            ...
            try {
                ...
                //Logger.Debug("gettingProjectionRef: {0}", imageFilename);
                ...
                if (string.IsNullOrWhiteSpace(_projectionWkt) && File.Exists(imageFilename.Substring(0, imageFilename.LastIndexOf(".")) + ".prj")) {
                    _projectionWkt =
